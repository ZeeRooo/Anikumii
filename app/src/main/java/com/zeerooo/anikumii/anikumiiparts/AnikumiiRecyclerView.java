...
public class AnikumiiRecyclerView extends RecyclerView {
    ...
    private void setDisposable() {
        compositeDisposable.add(
                publishProcessor
                        .flatMapSingle(page -> dataFromNetwork())
                        ...
                        .subscribe(arrayList -> {
                                ...
                                throwable -> {
                                    ...
                                    final Snackbar snackbar = AnikumiiUiHelper.Snackbar(rootView, getResources().getString(R.string.rxerror), Snackbar.LENGTH_INDEFINITE);
